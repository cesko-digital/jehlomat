...
import { INovaJehla } from "pages/novy-nalez"
    ...
    <>
      ...
      <Container>
        <FormWrapper>
          ...
          <TextButton
            text="Zobrazit a upravit na mapě"
          ...
          <FormItem>
            ...
            <TextInput
              ...
              readOnly
              value={datetime}
              placeholder="Datum nebylo zadáno"
            />
          </FormItem>
          <FormItem>
            ...
            <TextInput
              ...
              readOnly
              value={info}
              placeholder="Poznámky nebyly zadány"
            />
          </FormItem>
        </FormWrapper>
        <ButtonContainer>
