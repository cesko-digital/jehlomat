...
import { INovaJehla, STEPS } from "pages/novy-nalez"
import ZapnoutPolohu from "section/newFind/ZapnoutPolohu"
import Mapa from "section/newFind/Mapa"
...
const ZadatNalezMapa: FC<IZadatNalezMapa> = ({
  ...
  useEffect(() => {
    if (
      userSelectedLocation[0] != undefined &&
      userSelectedLocation[1] != undefined
    ) {
